		...
		<div class="card mb-3">
			<div class="card-body">
				<div class="post-header d-flex align-items-center mb-3">
					<img
						:src="
							getImageUrl(post.author.profileImage) || '/default-avatar.png'
						"
						alt="Profile"
					...
					<div v-if="post.comments.length > 0" class="comments-list">
						...
						>
							<div class="d-flex align-items-start">
								<img
									:src="
										getImageUrl(comment.user.profileImage) ||
										'/default-avatar.png'
									"
									alt="Profile"
								...
								<div class="comment-content flex-grow-1">
									...
									<div
										v-if="editingComment && editingComment._id === comment._id"
									...
									<div
										v-if="
											comment.user._id === currentUser._id && !editingComment
										"
