          ...
          <div class="mobile-profile-card">
            <div class="d-flex align-items-center mb-3">
              ...
              <div class="flex-grow-1">
                ...
                <p class="text-muted mb-0 small">{{ user?.bio || 'No bio yet' }}</p>
              </div>
            </div>
            <div class="d-flex gap-2">
              <button @click="$router.push('/home')" class="btn btn-primary btn-sm flex-grow-1">
                <i class="fas fa-home"></i> Home
              </button>
              <button @click="$router.push('/profile')" class="btn btn-outline-primary btn-sm">
                <i class="fas fa-user"></i>
              </button>
              <button @click="showCreatePost = true" class="btn btn-success btn-sm">
          ...
          <div class="sidebar-card">
            <div class="profile-section">
              ...
              <div class="d-grid gap-2">
                <button @click="$router.push('/home')" class="btn btn-primary btn-sm">
                  <i class="fas fa-home"></i> Home
                </button>
                <button @click="$router.push('/profile')" class="btn btn-outline-primary btn-sm">
          ...
          <div class="posts-container">
            <div class="posts-header">
              <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <button @click="showCreatePost = true" class="btn btn-primary btn-sm">
          ...
          <div class="card-body">
            <form @submit.prevent="createPost">
              ...
              <div class="d-flex justify-content-between">
                ...
                <button type="submit" class="btn btn-primary" :disabled="!newPost.content.trim()">
                  Post
                </button>
              </div>
            </form>
...
const createPost = async () => {
  try {
    const optimisticPost = {
      ...
      image: newPost.value.image ? URL.createObjectURL(newPost.value.image) : '',
      likes: [],
      comments: [],
